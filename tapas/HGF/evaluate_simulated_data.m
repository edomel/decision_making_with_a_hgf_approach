...
for i = 1:n_partecipants
    for m = 1:3
        name = strcat('../../computations/simulated_data/simulated_data_for_hgf_method', int2str(m), '_', int2str(i), '.mat');
        load(name);
        ...
        name = strcat('../../computations/simulated_data/fitted/simulated_data_fitted_method', int2str(m), '_', int2str(i), '.mat');
